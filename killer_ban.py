...
def hard_report(target_phone, username, is_ban=True, is_extreme=False, is_permanent=False, report_count=100):
    ...
    strength = "👺☠️ NO ESCAPE" if is_extreme else "KILLER 😈"
    ...
    total_sends = email_count + inapp_count + chat_count + spam_count + api_count
    success = 0
    current = 0
...
# === 4. SPAM FLOOD ===
    ...
    print(Fore.YELLOW + "[*] Wait 1–12 hours if not banned 🚫 try again")
    input(Fore.WHITE + "\nPress Enter to continue...")
